...
<!-- ================================== TOP NAVIGATION : END ================================== -->
	 ...
	 <section class="hero-section py-5" style="background-color: #ffe6f0; font-family: 'Raleway', sans-serif;">
  <div class="container">
    <div class="row align-items-center">
      <!-- Left content -->
      <div class="col-lg-6 mb-4 mb-lg-0">
        <h1 style="font-family: 'Playfair Display', serif; font-size: 7rem; color: #222;">Elevate Your Wardrobe</h1>
        <p style="font-size: 2rem; color: #555;">
        ...
        <div class="d-flex flex-wrap gap-3 mt-4">
          <a href="#" class="btn btn-dark btn-lg px-4 py-2 rounded-pill">
            <i class="bi bi-gender-male me-2"></i> Men's Collection
          </a>
          <a href="#" class="btn btn-outline-dark btn-lg px-4 py-2 rounded-pill">
      ...
      <div class="col-lg-6 text-center">
        <div class="overflow-hidden rounded-4 shadow" style="max-width: 110%; transform: rotateY(-5deg);">
          <img src="assets/images/sliders/slider1.jpg" alt="Fashion Collection" class="img-fluid" style="width: 110%; height: auto; object-fit: cover;">
        </div>
      </div>
    </div>
  </div>
